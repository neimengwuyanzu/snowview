package com.example.snowview.snow;
...
//        canvas.drawRect(getX() - getRadius(), getY() - getRadius(), getX() + getRadius(), getY() + getRadius(), paint);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            int line1EndX = (int) (line1StartX + radius * 0.3 * Math.cos(degree60));
            int line1EndY = (int) (line1StartY - radius * 0.3 * Math.sin(degree60));
            ...
            int line2EndX = (int) (line1StartX + radius * 0.3 * Math.cos(degree60));
            int line2EndY = (int) (line1StartY + radius * 0.3 * Math.sin(degree60));
